...
//           return;
//         }
//         const res = await axios.get(`${JOB_API_URL}/postedJobs`, {
//           headers: {
//             Authorization: `Bearer ${token}`, // ✅ header me bhejna compulsory
//           },
...
//   if (loading) {
//     return <p className="p-6 text-gray-600">Loading your posted jobs...</p>;
//   }
...
//                     onClick={() =>
//                       navigate(`/recruiter/ranked-applicants/${job._id}`)
//                     }
//                   >
//                     View Applications
//                   </button>
