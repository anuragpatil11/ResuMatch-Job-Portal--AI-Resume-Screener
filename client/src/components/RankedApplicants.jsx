...
//   const { jobId } = useParams(); // URL se jobId lena hai
...
//           `${APPLICATION_API_URL}/getRankedApplicants/${jobId}`,
//           {
//             headers: {
...
//         `${APPLICATION_API_URL}/updateStatus/${applicationId}`,
//         { status: statusUpdate[applicationId] },
//         {
//           headers: {
//             Authorization: `Bearer ${localStorage.getItem("token")}`,
//           },
...
//               ? { ...app, status: statusUpdate[applicationId] }
//               : app
//           )
//         );
//       }
...
//   };
//   useEffect(() => {
//     // get all keys (applicationIds) whose status changed
//     const ids = Object.keys(statusUpdate);
//     if (ids.length > 0) {
//       // update the most recent one
//       const latestId = ids[ids.length - 1];
//       handleUpdateStatus(latestId);
//     }
//   }, [statusUpdate]);

//   if (loading) return <p className="text-center">Loading...</p>;
//   if (!jobData) return <p className="text-center">No job data found</p>;
...
//             <strong>Job ID:</strong> {jobData.jobId}
//           </p>
//           <h2 className="text-2xl font-bold mb-2">{jobData.jobTitle}</h2>
//           <p className="mt-2">
...
//         {/* Applicants List */}
//         <h3 className="text-xl font-semibold mb-4">Ranked Applicants</h3>
//         {jobData.applications.length === 0 ? (
//           <p className="text-gray-600">No applicants have applied yet.</p>
//         ) : (
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
//             {jobData.applications.map((applications) => (
//               <div
//                 key={applications._id}
//                 className="border p-6 rounded-2xl shadow-md bg-white hover:shadow-lg transition"
//               >
//                 <h4 className="text-xl font-semibold text-gray-800 mb-2">
//                   {applications.applicant.name}
//                 </h4>
//                 <p className="text-gray-600">
//                   <strong>Email:</strong> {applications.applicant.email}
//                 </p>
//                 <p className="text-gray-600">
//                   <strong>Match Score:</strong> {applications.matchPercent}%
//                 </p>
//                 <p className="text-gray-600">
//                   <strong>Skills:</strong>{" "}
//                   {applications.applicant.extractedSkills.join(", ")}
//                 </p>
//                 <p className="text-gray-600">
...
//                 </p>
//                 <a
//                   href={applications.applicant.resumeUrl}
//                   target="_blank"
...
//                   <span className="px-2 py-1 rounded text-sm bg-gray-100 border">
//                     {applications.status}
//                   </span>
//                 </p>
...
//                         value={
//                           statusUpdate[selectedApp._id] || selectedApp.status
//                         }
//                         onChange={(e) =>
...
//                         <button
//                           onClick={() => {
//                             handleUpdateStatus(selectedApp._id);
//                             closeModal();
//                           }}
